          ...
          <div>
            <Breadcrumb className="mb-6 flex flex-wrap items-center text-sm">
              <BreadcrumbList>
                <Fragment>
                  <BreadcrumbItem>
                    <BreadcrumbLink href="#">Utazási csomagok</BreadcrumbLink>
                  </BreadcrumbItem>
                  <BreadcrumbSeparator />
                </Fragment>
                <Fragment>
                  <BreadcrumbItem>
                    <BreadcrumbLink href="#">Csomag</BreadcrumbLink>
                  </BreadcrumbItem>
                  <BreadcrumbSeparator />
                </Fragment>
                <Fragment>
            ...
            <Accordion type="multiple">
              <AccordionItem value="item-0">
                ...
                <AccordionContent className="md:pb-6">
                  Jelenleg öt hely maradt. Az utazás hamarosan megtöltődik,
                  ezért ne halogatd a foglalást.
                </AccordionContent>
              </AccordionItem>
          ...
          <div>
            <div className="lg:sticky lg:top-32">
              ...
              <div className="mb-7 flex flex-col flex-wrap sm:flex-row md:mb-8">
                <p className="text-2xl font-bold md:text-4xl">45 000 Ft</p>
                <div className="mx-4 hidden w-px self-stretch bg-background-alternative sm:block" />
                <div className="flex flex-col gap-1">
                  <Star rating={3.5} />
                  <p className="text-sm">(4.8 csillag) • 47 értékelés</p>
                </div>
              </div>
              <div className="mb-4 mt-2 flex flex-col gap-y-4">
                <Button title="Foglalás most">Foglalás most</Button>
                <Button title="Tudj meg többet" variant="secondary">
                  Tudj meg többet
                </Button>
              </div>
              <p className="text-center text-xs">
                Harminc napig visszafizetjük az árát
              </p>
            </div>
          </div>
        </div>
