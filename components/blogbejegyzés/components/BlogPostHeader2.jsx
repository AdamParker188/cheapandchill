      ...
      <div className="container">
        <div className="rb-12 mb-12 flex flex-col items-start justify-start md:mb-18 lg:mb-20">
          ...
          <h1 className="text-5xl font-bold md:text-7xl lg:text-8xl">
            Hogyan utazz olcsón és ne maradj pénz nélkül
          </h1>
        </div>
        ...
        <div className="flex w-full flex-col items-start justify-between md:flex-row">
          <div className="rb-4 mb-4 flex items-center sm:mb-8 md:mb-0">
            <div className="mr-8 md:mr-10 lg:mr-12">
              <p className="mb-2">Írta</p>
              <p className="font-medium">Fiatal Utazási Ötletterv</p>
            </div>
            <div className="mr-8 md:mr-10 lg:mr-12">
              <p className="mb-2">Közzétéve</p>
              <p className="font-medium">2024. március 15.</p>
            </div>
          </div>
