          ...
          <div className="max-size-full order-last flex items-center justify-center overflow-hidden md:order-first">
            ...
            >
              <Dialog>
                ...
                <DialogContent>
                  <VideoIframe video="https://picsum.photos/900/600" />
                </DialogContent>
              </Dialog>
            </TabsContent>
            <TabsContent
          ...
          <TabsList className="order-first flex-col gap-8 py-8 md:order-last md:py-0">
            ...
            >
              <h3 className="mb-3 text-2xl font-bold md:mb-4 md:text-3xl md:leading-[1.3] lg:text-4xl">
                Válaszd ki az utazást
              </h3>
              <p>
                Nézd meg az összes csomagot és válaszd ki azt, amely a szívedhez
                szól. Minden csomag más, és mindegyik egy új történet.
              </p>
            </TabsTrigger>
            <TabsTrigger
              value="tab-two"
